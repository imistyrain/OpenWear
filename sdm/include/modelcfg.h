...
static int IteraLandmarkIndex1[] = { 3, 6, 8, 10, 13, 19, 24, 36, 45, 30, 48, 54 };
static int LandmarkLength2 = 12;
static int IteraLandmarkIndex2[] = { 3, 6, 8, 10, 13, 19, 24, 36, 45, 30, 48, 54 };
static int LandmarkLength3 = 12;
static int IteraLandmarkIndex3[] = { 3, 6, 8, 10, 13, 19, 24, 36, 45, 30, 48, 54 };
static int LandmarkLength4 = 20;
static int IteraLandmarkIndex4[] = { 3, 6, 8, 10, 13, 18, 20, 23, 25, 36, 39, 42, 45, 30, 31, 35, 48, 51, 54, 57 };
static int LandmarkLength5 = 20;
static int IteraLandmarkIndex5[] = { 3, 6, 8, 10, 13, 18, 20, 23, 25, 36, 39, 42, 45, 30, 31, 35, 48, 51, 54, 57 };
